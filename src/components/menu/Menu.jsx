...
function Menu() {
    ...
    return (
        <div className="menu">
            ...
            <button className={location.pathname === '/favorite' || location.pathname === '/rules' || location.pathname === '/details' ? 'active' : ''}>
                <Link to="/favorite" style={{ textDecoration: "none" }}>최애 통장</Link>
            </button>
