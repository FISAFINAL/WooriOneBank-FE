...
function Main(props) {
  ...
  return (
    <div>
              ...
              {index === 0 ? (
                <>
                  ...
                  <div className="content-wrapper">
                    ...
                    <h3>아이유, RIIZE(라이즈), 르세라핌, 성시경</h3>
                    <p>
                      <b>올림픽공원 우리금융아트홀</b>
                    </p>
                    <p>2024.05.09 14시</p>
                    <button className="btn" onClick={onClickReservation}>
                      티켓 예매하러 가기
                    </button>
                  </div>
                </>
                ...
                <>
                  <div className="content-wrapper2">
                    <h1>최애통장 가입하고</h1>
                    <p>우리 WON THE STAGE 가자 !<br></br><br></br></p>
      ...
      <button className="cta-button" onClick={onClickFavorite}>
        최애 통장 개설하기
      </button>
      <Footer />
    </div>
